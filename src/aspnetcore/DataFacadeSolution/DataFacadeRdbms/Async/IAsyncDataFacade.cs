...
namespace DataFacadeRdbms.Async
{
    ...
    public interface IAsyncDataFacade
    {
        ...
        Task CloseConnectionAsync(IDbConnection conn);
        ...
        /// <returns></returns>
        Task<IDbTransaction> GetTransactionAsync(IDbConnection conn);
        ...
        /// <returns><see cref="IDataReader">.</returns>
        Task<IDataReader> ExecuteReaderAsync(IDbCommand cmd, CommandBehavior cmdBehavior);
